...
print A[:]   # 输出 [100 200 300 400 500 600]
print A[:3]  # 输出 [100 200 300]
print A[1:]  # 输出 [200 300 400 500 600]
print A[1:3] # 输出 [200 300]
print "\n"

B = array([[100,200,300,400], ['A', 'B', 'C', 'D'], [1.1, 2.2, 3.3, 4.4], ["UU", "VV", "WW", "XX"]])
print B[1,2]    # 输出 C
